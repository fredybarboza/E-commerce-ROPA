...
@section('content')
   <div class="contenedor">
    ...
    @csrf
    @method('POST')
            <input type="text" id="idProducto" maxlength="19" name="id_producto" autocomplete="off" value="{{$id_producto}}" hidden>
            <input type="text" id="cantidad" maxlength="19" name="cantidad" autocomplete="off" value="{{$cantidad}}" hidden>
        ...
        <button type="submit" name="metodocompra" value="1" class="btn-enviar">Enviar</button>
    </form>
  </div>
